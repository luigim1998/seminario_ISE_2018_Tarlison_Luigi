# programa_de_teste
# Created at 2018-11-01 02:38:12.904324
...
def pressed_up():
    ...
    hexi.vibration(100) #vibra por 100 milisegundos
    hexi.enable_bt_upd_sensors() #ativa a atualizacao automatica dos sensores para 5 segundos
 
def pressed_down():
    print("Down Button Pressed")
    hexi.vibration(100) #vibra por 100 milisegundos
    hexi.disable_bt_upd_sensors() #desativa a atualizacao automatica dos sensores
    
def toggle_ble():
    try:
        print("Left Button Pressed")
        hexi.vibration(100)
        hexi.bt_driver.toggle_adv_mode() #muda o status do bluetooth
...
def toggle_touch():
    try:
        ...
        hexi.vibration(100)
        hexi.bt_driver.toggle_tsi_group() #muda o uso dos botões verticais
    except Exception as e:
